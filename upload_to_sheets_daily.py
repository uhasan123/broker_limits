...
debtor_level = debtor_level.where(pd.notnull(debtor_level), None)
...
generate_segment_level_data_day = generate_segment_level_data_day.where(pd.notnull(debtor_level), None)
...
generate_segment_level_data_week = generate_segment_level_data_week.where(pd.notnull(debtor_level), None)
...
generate_segment_level_data_month = generate_segment_level_data_month.where(pd.notnull(debtor_level), None)
