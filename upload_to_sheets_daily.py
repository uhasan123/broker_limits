...
generate_segment_level_data_week = generate_segment_level_data_week.where(pd.notnull(generate_segment_level_data_week), None)
...
generate_segment_level_data_month = generate_segment_level_data_month.where(pd.notnull(generate_segment_level_data_month), None)
