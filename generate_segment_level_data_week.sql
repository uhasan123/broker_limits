...
sum(case when (i.paid_date>snapshot_date-7 and i.paid_date<=snapshot_date) and i.paid_date is not null then i.approved_accounts_receivable_amount/100.0 else 0 end) as invoice_paid_dollars,
